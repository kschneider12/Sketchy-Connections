...
class CheckboxButton(Button):
    ...
    def __init__(self, position, size, funct, text, active = False):
        ...
        self.check_img = pygame.image.load('assets/textures/colorwheel_bkg.png')
    ...
    def draw(self, screen, curr_color):
        ...
        if self.active:
            screen.blit(self.check_img, (self.pos[0] - self.width / 2, self.pos[1] - self.height / 2))
        screen.blit(self.text_surface, (self.pos[0] + self.width / 1.5, self.pos[1] - self.height / 2))
